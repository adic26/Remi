    ...
    public class TestSummary : ITestSummary
    {
        ...
        public string ToString(string rowSeparator, string columnSeparator)
        {
            string result = string.Join(rowSeparator, 
                string.Join(columnSeparator, "Final Result", FinalResult),
                string.Join(columnSeparator, "Date Started", DateStarted),
                string.Join(columnSeparator, "Date Completed", DateCompleted),
                string.Join(columnSeparator, "Duration", Duration)
                );
            return result;
        }
